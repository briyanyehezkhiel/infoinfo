...
$sql1 = "SELECT DISTINCT article.id, article.article_like, article.article_dislike, article.gambar, article.title, article.article_comment, article.created_at, article.content, userinfo.id AS user_id, userinfo.username, userinfo.profile_picture
          FROM article
  ...
  <div class="container-fluid">
    ...
    <div class="isi bg-light pt-4">
        <div class="container mb-5">
             ...
             <div class="kembali bg-light">
            <a href="feed.php"><button class="balek">
                <img src="src/balek.png" width="27px">
            </button></a>
            </div> 
             <!-- isi -->
			...
			<?php foreach($articles as $row): ?>
				 ...
				 <div class="bg-white border-gray mt-4">
                            ...
                            if (in_array($file_extension, ['jpg', 'jpeg', 'png', 'gif'])): ?>
                                ...
                                <img class="img-fluid" src="img/<?= $file_path; ?>">
                                </div>
                            <?php endif; ?>
