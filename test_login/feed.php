  ...
  <div class="container-fluid">
    ...
    <div class="isi bg-light pt-4">
        <div class="container mb-5">
			...
			<?php 
			function compareCreatedAt($article1, $article2) {
    		return strtotime($article2['created_at']) - strtotime($article1['created_at']);
			}

			// Mengurutkan array $articles berdasarkan created_at
			usort($articles, 'compareCreatedAt');
